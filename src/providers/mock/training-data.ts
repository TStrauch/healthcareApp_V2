 ...
 var category_two: Exercise[] = [
   {id:1, name:'Circle your Shoulders', description:'Start with circling your shoulders backwards in small movements.\
    Then try to maximise the size of circles.  After 30 seconds, switch the direction\
   ...
   {id:3, name:'Stretch and Strengthen your Shoulders', description:'Create a U-form with your arms, the elbows are at the height of your shoulders. \
   ...
   {id:4, name:'Keep your Shoulders together', description:'Clap your fingers at chest height. Create a tension by pressing the shoulder blades together and pull open the elbows.\
 ...
 var category_three: Exercise[] = [
   ...
   At the last time, go the same item order back.', duration: 60, goal:'Flexibility of the eye lense', image: 'assets/img/training/eye2.PNG'},
   ...
   {id:4, name:'Coordinate your Eyes and Hands', description:'Stretch your arms at the height of your shoulders. Turn your head to the left side. The left thumb points up whereas the right one points down.\
