...
*/
export var InitialQuestionnaire = (function () {
    function InitialQuestionnaire(navCtrl) {
        this.navCtrl = navCtrl;
    }
    InitialQuestionnaire.prototype.ionViewDidLoad = function () {
        console.log('Hello InitialQuestionnaire Page');
    };
    InitialQuestionnaire = __decorate([
        Component({
